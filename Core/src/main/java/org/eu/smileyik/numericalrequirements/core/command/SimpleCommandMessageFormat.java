...
public class SimpleCommandMessageFormat implements CommandMessageFormat, CommandTranslator {
    ...
    public String notFound() {
        return I18N.trp("command", "command.error.not-found");
    }

    @Override
    public String notFound(String suggestCommandHelp) {
        return I18N.trp("command", "command.error.not-found-with-suggest", suggestCommandHelp);
    }

    @Override
    public String commandError() {
        return I18N.trp("command", "command.error.command-error");
    }

    @Override
    public String commandError(String suggestCommandHelp) {
        return I18N.trp("command", "command.error.command-error-with-suggest", suggestCommandHelp);
    }

    @Override
    public String notPlayer() {
        return I18N.trp("command", "command.error.not-player");
    }

    @Override
    public String notPermission() {
        return I18N.trp("command", "command.error.no-permission");
    }
